...
public class GVJ_TokenMaker extends AbstractTokenMaker {
    private final String operators = "=|><&";
    private final String separators = "()[]{}";
    private final String separators2 = ".,";			// Characters you don't want syntax highlighted but separate identifiers.
    private final String shellVariables = ":#-?$!*@_";	// Characters that are part of "$<char>" shell variables; e.g., "$_".
    private int currentTokenStart;
    private int currentTokenType;

    public GVJ_TokenMaker() {
        super();
    }
    ...
    public TokenMap getWordsToHighlight() {
        ...
        tokenMap.put("node", Token.OPERATOR);
        ...
        tokenMap.put("shape", Token.RESERVED_WORD_2);
        tokenMap.put("height", Token.RESERVED_WORD);
        return tokenMap;
    }
